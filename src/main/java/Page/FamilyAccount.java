...
public class FamilyAccount extends TestBase {
    ...
    @AndroidFindBy(xpath = "//android.widget.TextView[@text=\"Add more policies of Dummy\" or @text=\"Add more policies of Kalpana\"]")
    WebElement AddMore;
...
//Ashok mishra policy found family flow
    @AndroidFindBy(uiAutomator = "new UiSelector().text(\"Kalpana Mishra\")")
    WebElement kalpana;


    @AndroidFindBy(xpath = "//android.widget.TextView[@text='Send invite to Dummy' or @text='Send invite to Kalpana']")
    ...
    public void Family() throws InterruptedException {
        ...
        try{
            ...
            try{
                if(Back1.isDisplayed() && kalpana.isDisplayed()) {
                    ...
                    TestUtil.assertText(kalpana, "Kalpana Mishra");
        ...
        try {
            ...
            TestUtil.assertText(AddMore, "Add more policies of Kalpana");
        }
...
//        Thread.sleep(2000);
        ...
        TestUtil.click(Back1,"Back clicked");
    }
}
